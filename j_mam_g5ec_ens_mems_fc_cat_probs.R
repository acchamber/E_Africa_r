...
if (glosea5 & tercile) probs_file='g5_ppn_ke_jan_MAM2020_etprobs.txt'
if (glosea5 & (tercile == FALSe)) probs_file='g5_ppn_ke_jan_MAM2020_eqprobs.txt'
if ((glosea5 == FALSE) & tercile) probs_file='ec_ppn_ke_jan_MAM2020_etprobs.txt'
if ((glosea5 == FALSE) & (tercile == FALSE)) probs_file='ec_ppn_ke_jan_MAM2020_eqprobs.txt'
...
if (glosea5) fc_name <- "g5_ppn_ke_jan_MAM2020_mems"
if (glosea5 == FALSE) fc_name <- "ec_ppn_ke_jan_MAM2020_mems"
